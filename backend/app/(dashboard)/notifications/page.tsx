  ...
  return (
    <div style={{ maxWidth: 640, margin: "0 auto", padding: "48px 24px 64px" }}>
      ...
      <GlassCard padding="40px 24px" style={{ textAlign: "center" }}>
        ...
        <h2 style={{ fontSize: "1.1rem", fontWeight: 700, color: "var(--color-text-primary)", marginBottom: 8 }}>
          No notifications yet
        </h2>
        <p style={{ fontSize: "0.85rem", color: "var(--color-text-muted)", lineHeight: 1.5, maxWidth: 360, margin: "0 auto" }}>
          When someone replies to your posts, approves your uploads, or mentions you — it&apos;ll show up here.
        </p>
      </GlassCard>
    </div>
  );
