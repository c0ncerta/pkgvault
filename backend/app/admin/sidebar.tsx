...
import {
  IconDashboard, IconQueue, IconCatalog, IconLink,
  IconHardDrive, IconUsers, IconClipboard, IconArrowLeft,
    ...
    <aside style={{
      ...
      <div style={{ padding: "0 12px 20px", borderBottom: "1px solid rgba(255,255,255,0.06)", marginBottom: 12 }}>
        <Link href="/" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: 10 }}>
          <Logo size={26} />
          <span style={{ fontSize: "0.95rem", fontWeight: 700, color: "var(--color-text-primary)", letterSpacing: "-0.02em" }}>
            Admin Panel
          </span>
        </Link>
      </div>
        ...
        return (
          <Link
            ...
            style={{
              ...
              boxShadow: active ? "inset 0 1px 0 rgba(255,255,255,0.08), 0 2px 8px rgba(99, 102, 241, 0.18)" : undefined,
            }}
          >
            {active && (
              <span style={{
            ...
            <Icon size={16} style={{ opacity: active ? 1 : 0.6, color: active ? "#a78bfa" : undefined }} />
            {item.label}
          </Link>
        );
      })}
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            <div style={{ fontSize: "0.8rem", fontWeight: 600, color: "var(--color-text-primary)" }}>{userName}</div>
            <div style={{ fontSize: "0.65rem", color: "#818cf8", textTransform: "uppercase", fontWeight: 600, letterSpacing: "0.04em" }}>
              {role}
            </div>
          </div>
        </div>
