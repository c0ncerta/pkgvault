...
import { pkgFiles, forumThreads, users } from "@/db/schema";
...
import { IconUpload, IconForum } from "@/components/ui/icons";
  ...
  return (
    <GlassCard padding="22px 24px" style={{ display: "flex", flexDirection: "column", gap: 14 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <h3 style={{ fontSize: "0.95rem", fontWeight: 700, color: "var(--color-text-primary)", display: "flex", alignItems: "center", gap: 8 }}>
          <span style={{
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
        {items.map((it) => {
          ...
          return (
            <Link key={`${it.kind}-${it.id}`} href={href} style={{
              display: "flex", alignItems: "center", gap: 10,
              padding: "8px 10px", borderRadius: 10, textDecoration: "none",
              color: "var(--color-text-primary)", fontSize: "0.85rem",
              transition: "background 0.15s",
            }}>
              <span style={{ width: 18, display: "inline-flex", alignItems: "center", justifyContent: "center", color: tint }}>
                <Icon size={14} />
              </span>
              ...
              <span style={{ fontSize: "0.7rem", color: "var(--color-text-muted)", fontFamily: "var(--font-mono)", whiteSpace: "nowrap" }}>
